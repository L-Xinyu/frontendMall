        ...
        <div class="content inner">
            <section class="filter-section clearfix">
                ...
                <div class="sort-box bgf5">
                    ...
                    <div class="sort-text" id="orderPrice" @click="changeOrderPrice">Price <i id="orderPriceIcon"
                                                                                           class="iconfont"></i></div>
                    <div class="sort-total pull-right">Total <span v-text="total"></span> Products</div>
                </div>
            </section>
